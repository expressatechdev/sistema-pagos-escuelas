...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Recoger datos
    // FORZAR VALOR DE VOLUNTAD
    $_POST['voluntad_especifica'] = $_POST['voluntad_especifica'] ?? '';
    $voluntad = !empty($_POST['voluntad_especifica']) ? $_POST['voluntad_especifica'] : 'Por Asignar';
            ...
            <form method="POST" action="">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3" id="voluntad_input_container">
