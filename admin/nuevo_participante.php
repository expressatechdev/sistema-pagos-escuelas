...
<body>
        ...
        <div class="form-card">
            ...
            <form method="POST" action="">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="voluntad_tipo" class="form-label">
                                Voluntad
                            </label>
                            <select class="form-select" id="voluntad_tipo" name="voluntad_tipo" onchange="toggleVoluntadInput()">
                                <option value="Por Asignar">Por Asignar</option>
                                <option value="Especificar">Especificar Voluntad</option>
                            </select>
                        </div>
                        
                        <div class="col-md-6 mb-3" id="voluntad_input_container" style="display: none;">
                            <label for="voluntad_especifica" class="form-label">
                                Especifique la Voluntad <span class="required">*</span>
                            </label>
                            <input type="text" 
                                class="form-control" 
                                id="voluntad_especifica" 
                                name="voluntad_especifica" 
                                placeholder="Ejemplo: $50, $100, Libre, etc.">
                            <small class="text-muted">Ingrese el monto o tipo de voluntad</small>
                        </div>
                    </div>

                    <input type="hidden" id="voluntad" name="voluntad" value="Por Asignar">
    ...
    <script>
        ...
        function toggleVoluntadInput() {
            const tipoVoluntad = document.getElementById('voluntad_tipo').value;
            const inputContainer = document.getElementById('voluntad_input_container');
            const inputEspecifica = document.getElementById('voluntad_especifica');
            
            if (tipoVoluntad === 'Especificar') {
                inputContainer.style.display = 'block';
                inputEspecifica.required = true;
            } else {
                inputContainer.style.display = 'none';
                inputEspecifica.required = false;
            }
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    const tipoVoluntad = document.getElementById('voluntad_tipo').value;
                    const voluntadEspecifica = document.getElementById('voluntad_especifica').value;
                    const voluntadHidden = document.getElementById('voluntad');
                    
                    if (tipoVoluntad === 'Especificar' && voluntadEspecifica) {
                        voluntadHidden.value = voluntadEspecifica;
                    } else {
                        voluntadHidden.value = 'Por Asignar';
                    }
                });
            }
        });
