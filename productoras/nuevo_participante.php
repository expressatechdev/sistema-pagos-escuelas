...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        try {
            ...
            $sql = "INSERT INTO participantes (nombre, apellido, email, whatsapp, pais, ciudad, voluntad, productora_id, token_acceso) 
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
            
            $stmt = $conexion->prepare($sql);
            $stmt->bind_param("ssssssssi", $nombre, $apellido, $email, $whatsapp, $pais, $ciudad, $voluntad, $productora_id, $token);
            $stmt->execute();
            ...
            foreach ($escuelas as $escuela) {
                ...
                $sql_inscripcion = "INSERT INTO inscripciones (participante_id, escuela, precio_modulo, fecha_inscripcion) 
                                    VALUES (?, ?, ?, CURDATE())";
                ...
                $sql_estado = "INSERT INTO estado_cuenta (participante_id, escuela, modulo_actual, total_adeudado) 
                               VALUES (?, ?, 1, ?)";
            ...
            // Registrar actividad
            registrarActividad($conexion, 'productora', $productora_id, 'CREAR_PARTICIPANTE', 
                "Participante creado: $nombre $apellido ($email)");
            
            // Enviar email de bienvenida al participante
                ...
                $mensaje_email = "
                    ...
                    <div style='background: #e8f5e9; padding: 15px; border-radius: 10px; margin: 20px 0;'>
                        ...
                        <ol style='margin: 10px 0;'>
                            ...
                            <li>Sigue las instrucciones para registrar tu pago</li>
                        </ol>
                    </div>
            ...
            $mensaje = "¡Participante registrado exitosamente! Se ha enviado un email de bienvenida a $email";
...
<head>
    ...
    <title>Nuevo Participante - Panel Productora</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li>
                <a href="dashboard_productora.php">
            ...
            <li>
                <a href="nuevo_participante.php" class="active">
    ...
    <div class="main-content">
        <div class="form-card">
            <div class="form-header">
                ...
                <p>Complete el formulario para agregar un nuevo participante a su equipo</p>
            </div>
            ...
            <form method="POST" action="">
                ...
                <!-- Botones -->
                <div class="text-end">
                    <a href="dashboard_productora.php" class="btn-cancel">
